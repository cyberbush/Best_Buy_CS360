              ...
              <div class="container_user align-content-center">
                <div class="card bg-light border border-primary rounded-5" style="width:auto">
                  ...
                  <div class="card-body text-center ">
                    <h4 class="card-title text-dark font-weight-bold">Service #1326</h4>
                    <p class="card-text text-dark">This is a Service, it is this thingy.</p>
            ...
            <div class="row">
              <div class="container_user">
                <div class="card bg-light border border-primary rounded-5" style="width:auto">
                  <img class="card-img-top" src="../components/Logo/logo.png" alt="Card image">
                  <div class="card-body text-center ">
                    <h4 class="card-title text-dark fw-bold">service #235346526</h4>
                    <p class="card-text text-dark">This is a service, it is this thingy.</p>
            ...
            <div class="row">
              <div class="container_user">
                <div class="card bg-light border border-primary rounded-5" style="width:auto">
                  <img class="card-img-top" src="../components/Logo/logo.png" alt="Card image">
                  <div class="card-body text-center ">
                    <h4 class="card-title text-dark fw-bold">Service #2342346</h4>
                    <p class="card-text text-dark">This is a service, it is this thingy.</p>
            ...
            <div class="row">
              <div class="container_user">
                <div class="card bg-light border border-primary rounded-5" style="width:auto">
                  <img class="card-img-top" src="../components/Logo/logo.png" alt="Card image">
                  <div class="card-body text-center ">
                    <h4 class="card-title text-dark fw-bold">Service #13226</h4>
                    <p class="card-text text-dark">This is a service, it is this thingy.</p>
                    <p class="display-5 my-4 text-primary fw-bold">$1000.99/mo</p>
                    <!--Add link to cart database here!-->
                    <button type="button" class="btn btn-primary btn-lg">
