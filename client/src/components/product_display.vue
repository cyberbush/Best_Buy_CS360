...
<div class="container-fluid d-flex justify-content-center">
  <div class="row mt-5">
    ...
    <div class="card-body pt-0 px-0">
      ...
      <div class="mx-3 mt-3 mb-2"><button type="button" style="background-color: #92FE9D; border: #92FE9D" class="btn btn-success btn-block"><small>BUILD & PRICE</small></button></div>
